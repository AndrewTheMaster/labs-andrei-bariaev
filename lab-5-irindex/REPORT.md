...
| N | термов | RAM (оценка, «до») | файл `.irx` («после») | сжатие |
|--:|-------:|-------------------:|----------------------:|-------:|
| 400 | 16 | **9.7 MiB** | **17.1 KiB** | **580×** |
| 2000 | 16 | **234 MiB** | **84.6 KiB** | **2833×** |

RAM включает тексты в `InvIndex.Docs`; на диск — только сжатые постинги (delta+varint).
