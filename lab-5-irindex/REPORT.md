...
- поддержать булевы операции и расширения из задания: **ADJ**(*a*, *b*) — строгая смежность терминов, **NEAR**(*k*, *a*, *b*) — два термина на расстоянии не более *k* позиций, **NOT** с обычной семантикой дополнения множества документов;
...
- поддержать файловый индекс с постраничной подгрузкой через **`mmap`** (операционная система подгружает страницы по доступу);
- обеспечить сжатие постингов на диске: **delta-encoding + varint bitpacking**;
